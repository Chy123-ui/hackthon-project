...
start "AIWenYou-Backend" cmd /c "chcp 65001 >nul && cd /d %~dp0backend && set PYTHONIOENCODING=utf-8 && .venv\Scripts\python -m uvicorn app.main:app --host 0.0.0.0 --port 8000 --reload --no-color"
